...
const Salon = {
  ...
  newCampaign: async function (campaignID, topic, speaker, sponsor) {
    let self = this;
    let data = self.instance.methods.newCampaign(campaignID, topic, speaker, sponsor).encodeABI();
    let transaction = {
  ...
  register: async function (campaignID) {
    let self = this;
    let data = self.instance.methods.register(campaignID).encodeABI();
    let transaction = {
      from: self.instance.options.from,
      to: self.instance.options.address,
      gasPrice: self.instance.options.gasPrice,
  ...
  checkin: async function (campaignID) {
    let self = this;
    let data = self.instance.methods.checkin(campaignID, self.instance.options.from).encodeABI();
    let transaction = {
      from: self.instance.options.from,
      to: self.instance.options.address,
      gasPrice: self.instance.options.gasPrice,
  ...
  closeCampaign: async function (campaignID) {
    let self = this;
    let data = self.instance.methods.closeCampaign(campaignID).encodeABI();
    let transaction = {
      from: self.instance.options.from,
      to: self.instance.options.address,
      gasPrice: self.instance.options.gasPrice,
